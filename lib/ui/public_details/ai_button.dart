...
class AiButton extends StatelessWidget {
  ...
  Widget _buildAdaptiveSlider(
    ...
    final gradientColors = _getPlatformGradientColors(context);
    final backgroundColor = _getPlatformBackgroundColor(context);
  ...
  List<Color> _getPlatformGradientColors(BuildContext context) {
    final aiButtonColor = AppColors.getAiElevatedButton(context);
  ...
  Color _getPlatformBackgroundColor(BuildContext context) {
    return AppColors.getAiElevatedButton2(context).withOpacity(0.9);
  }
