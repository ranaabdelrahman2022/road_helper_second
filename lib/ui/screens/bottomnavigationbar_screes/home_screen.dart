  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Container(
          decoration: BoxDecoration(
            color: isSelected ? const Color(0xFF033E90) : const Color(0xFFB7BCC2),
                ...
                child: Transform.scale(
                  ...
                  child: isIOS
                      ? CupertinoSwitch(
                          value: isSelected,
                          onChanged: onToggle,
                          activeColor: const Color(0xFF01122A),
                          trackColor: const Color(0xFF808080),
                        )
                      : Switch(
                          value: isSelected,
                          onChanged: onToggle,
                          activeColor: const Color(0xFF01122A),
                          activeTrackColor: const Color(0xFF01122A),
