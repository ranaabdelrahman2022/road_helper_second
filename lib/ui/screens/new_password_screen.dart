...
class _NewPasswordScreenState extends State<NewPasswordScreen>
  ...
  Widget _buildPasswordField(double maxWidth, bool isIOS) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: hasError ? Colors.red : const Color(0xFF4285F4),
        ),
        color: Colors.white,
      ),
      child: isIOS
  ...
  Widget _buildConfirmPasswordField(double maxWidth, bool isIOS) {
    final hasError = _confirmPasswordController.text.isNotEmpty && !passwordsMatch;
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
      ...
      child: Row(
        children: [
          Icon(
            ...
            color: isMet ? Colors.green : const Color(0xFF4285F4),
            size: 16,
          ),
          const SizedBox(width: 8),
          Text(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          if (isPasswordValid)
            BoxShadow(
              color: const Color(0xFF023A87).withOpacity(0.3),
              blurRadius: 8,
      ...
      child: isIOS
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: isPasswordValid ? const Color(0xFF023A87) : Colors.grey,
